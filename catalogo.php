...
<body>
    ...
    <script>
        ...
        function abrirModalNuevo() {
            ...
            mostrarPreview(null);
            // asegurar que el modal se muestra si la función es llamada programáticamente
            modalProducto.show();
        }

        function abrirModalEditar(productoOrJson) {
            // aceptar tanto objeto como JSON string (evita roturas al inyectar JSON en onclick)
            var producto = (typeof productoOrJson === 'string') ? JSON.parse(productoOrJson) : productoOrJson;

            limpiarErroresProducto();
            document.getElementById('tituloModalProducto').textContent = 'Editar Producto';
            document.getElementById('productoId').value = producto.id || '';
            // aceptar cualquiera de los campos que el backend pueda devolver
            document.getElementById('imagenActual').value = producto.imagen || producto.imagen_url || '';
            ...
            document.getElementById('imagenProducto').value = '';
            mostrarPreview(producto.imagen_url || producto.imagen || null);
            modalProducto.show();
        }
